		...
		<div className={styles.maincontainer}>
			<div className={styles.container}>
				...
				<div className={styles.col2}>
					...
					<p className={styles.p3}>
						Discover new and clever product in the Indiegogo newletter
					</p>
					<input
						type="email"
					...
					<br />
					<label>
						<input type="checkbox" className={styles.inputcheck} />I agree to
						the Terms of Use and have read and understand the Privacy Policy
					</label>
					<br />
					<button className={styles.inputsubmit}>SIGN ME UP</button>
				</div>
			</div>
			...
			<div className={styles.subcontainer}>
				...
				<span className={styles.spans}>
					@2021 Indiegogo,Inc.All Right Reserved
				</span>
			</div>
		</div>
	);
