...
export const Slide=()=>{
    ...
    return(
        ...
        <div className={styles.sidecard}>
            ...
            <p className={styles.p12}>Indiegogo is where early adopters and innovation seekers find lively, imaginative tech before it hits the mainstream.</p>
            <button className={styles.btn1}>Sign Up Now</button>
